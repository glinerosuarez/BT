...
class ConfigTests(unittest.TestCase):
    def test_defaults(self) -> None:
        ...
        self.assertFalse(settings.use_hiring_cafe)
        self.assertTrue(settings.hiring_cafe_search_urls)
        self.assertIn("https://hiring.cafe/jobs/ai-research-intern-united-states", settings.hiring_cafe_search_urls)
        self.assertEqual(settings.hiring_cafe_max_results, 20)
